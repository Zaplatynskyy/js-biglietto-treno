...
if (eta < 18){
    ...
    document.getElementById('prezzo_biglietto').innerHTML = prezzoBiglietto + 'euro';
    document.getElementById('nota').innerHTML = '*prezzo scontato al 20% per gli under 18';
    ...
    document.getElementById('prezzo_biglietto').innerHTML = prezzoBiglietto + 'euro';
    document.getElementById('nota').innerHTML = '*prezzo scontato al 20% per gli over 65';
